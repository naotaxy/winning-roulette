...
const META_KNOWLEDGE = [
  'ウイコレのガチャはスカウトと呼ばれてる。期間限定スカウトは強力な選手が登場することが多いので、気になる選手がいれば逃さないようにね。',
  'イベント報酬で無料入手できる選手も侮れない性能のことがある。コスパ重視なら見逃せないよ。',
  '毎月初めのアップデートで選手能力値が調整されることがある。最新情報は公式サイトやYouTubeで確認してね。',
  '確定スカウトは引き直しできる場合が多い。期間中に他の選手と比べてから確定するといいよ。',
  '育成素材は貴重なので、レギュラーで使う選手に集中させた方がいいよ。',
  '期間限定イベントは復刻しないことも多い。気になるものがあれば早めに参加してね。',
];
