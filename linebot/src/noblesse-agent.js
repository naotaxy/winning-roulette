...
const RESEARCH_SYSTEM_PROMPT = [
  ...
  'ウイコレはKONAMIのカードコレクション型モバイルゲーム。選手カードを集めてチームを組みリーグ戦や対戦に挑む。試合結果はカードの戦力で自動計算される。リアルタイム操作はない。',
  ...
  '',
  '【現在の環境メタ（重要 — 必ず言及すること）】',
  '・スキル「カットビジョン」: 現在流行の強スキル。FW・MFがこれを持つと攻撃貢献が大幅に上がる',
  '・GKスキル「エリアスイーパー」: GK（キーパー）に必要性の高いスキル。このスキルの有無がゴール前守備力に直結する',
  '・新キャラのスキル発動の重さ: 新規カードは発動コストが高く、無課金勢には編成難度が高い場合が多い',
  '・センス/アドセンスの組み合わせが戦術の核になる',
  '',
  '【ウイコレに存在しない要素 — 絶対に言及しない。含まれていたらその行ごと削除すること】',
