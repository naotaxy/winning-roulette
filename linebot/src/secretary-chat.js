...
const TOPICS = [
  ...
  },
  {
    ...
    replies: [
      [
        'はじめまして、秘書トラペル子です。',
        '米澤さんに雇われて、ウイコレの試合結果を読んだり、順位や縛りルールを持ってきたり、会話の未決議を整理したりしています。',
      ...
      [
        ...
        '名前は米澤さんのトラペルソからもらいました。ウイコレの結果登録、順位確認、縛りルール確認、未決議整理、段取りの下書き、軽い雑談ができます。',
  ...
  {
    name: 'shoppingSneakerMood',
    pattern: /(スニーカー見たい|靴見たい|スニーカーの気分)/,
    replies: [
      '靴を見る日は、気分の切り替えも一緒にしたい時かも。HOKAとか最近のMizunoの線、今のあなたに似合いそう。',
      'スニーカー見たい日は、足元から気分を立て直したい時っぽい。今日は定番より少しひねったほうが楽しそう。',
      'うん、見に行きたいね。履き心地で選ぶか、見た瞬間の気分で選ぶか、今日はどっちに寄ってる？',
    ],
  },
  {
...
const CASUAL_QUICK_REPLY_SCENES = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'スニーカー', text: 'スニーカー見たい' },
      { label: '器', text: '器見たい' },
    ],
  },
  {
    pattern: /(スニーカー見たい|靴見たい|スニーカーの気分|器見たい|うつわ見たい|食器見たい|器の気分|美味しいものの気分|おいしいものの気分|いいもの食べたい)/,
    options: [
      { label: '近くで', text: '近くで見たい' },
      { label: '良い店だけ', text: '良い店だけ知りたい' },
      { label: '気軽に', text: '気軽に寄りたい' },
