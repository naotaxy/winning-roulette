...
const TOKYO_AREA_HINTS = [
  {
    ...
    spots: [
      { name: '神田川', query: '神田川 中野', reason: '谷筋の線をそのまま辿れて、街の高低差がよくわかる場所。' },
  ...
  },
  {
    ...
    spots: [
      ...
      { name: '御茶ノ水橋', query: '御茶ノ水橋', reason: '名前そのものが水の通り道の記憶を抱えている場所。' },
    ],
  },
  {
